        ...
        {isUser ? (
          isBusking ? (
            <section className='text-black'>
              <section className='border-gray-600 border-b items-center pt-2 pt-4 pb-5 flex flex-row'>
                <h1 className='font-sans text-white text-3xl font-semibold w-96'>
                  {buskingData && buskingData.name}
                </h1>
                <div className='flex flex-row items-center border-l border-gray-400 grow justify-center'></div>
              </section>
