        ...
        {isUser ? (
          isBusking ? (
            <section className='text-black'>
              <section className='border-gray-600 border-b items-center pt-3 pb-3 m-5 flex flex-row'>
                ...
                <div className='flex flex-row items-center border-l border-gray-400 grow'>
                  <h2 className='font-sans text-white text-2xl font-semibold ml-5'>
                    {!!name && `User: ${name}`}
                  </h2>
                  <h2 className='font-sans text-white text-2xl font-semibold ml-5'>
                    {!!playlistData && `Playlist: ${playlistData.name}`}
                  </h2>
                </div>
              </section>
